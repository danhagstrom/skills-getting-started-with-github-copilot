document.addEventListener("DOMContentLoaded", () => {
  ...
  // Handle unregister action for any participant delete button
  activitiesList.addEventListener("click", async (event) => {
    ...
    const activity = decodeURIComponent(deleteButton.dataset.activityName);
    const email = decodeURIComponent(deleteButton.dataset.participantEmail);
